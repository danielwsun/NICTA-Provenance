...
delcln_idx = InterStoreConst('raw', 'GeelongWifiStatusEg.csv', 'CleanByDelete', 'delcln', delcln);
...
repcln_idx = InterStoreConst('raw', 'GeelongWifiStatusEg.csv', 'CleanByRepair', 'repcln', repcln);

 ...
 * correctly parsed.*/
raw = LOAD 'GeelongWifiStatsEg.csv' USING com.nicta.provenance.pigUDF.ProvLoader('localhost', '8888');
...
/* Store result*/
STORE delcln_loc_ordered INTO 'someidx' USING com.nicta.provenance.pigUDF.ProvStorer('DelClnLocResult', 'localhost', '8888');
...
STORE delcln_url_ordered INTO 'someidx' USING com.nicta.provenance.pigUDF.ProvStorer('DelClnURLResult', 'localhost', '8888');
...
STORE repcln_loc_ordered INTO 'someidx' USING com.nicta.provenance.pigUDF.ProvStorer('RepClnLocResult', 'localhost', '8888');
...
STORE repcln_url_ordered INTO 'someidx' USING com.nicta.provenance.pigUDF.ProvStorer('RepClnURLResult', 'localhost', '8888');
